...
class ElectrumClient extends Client{
    ...
    blockchainAddress_history(address, pagination){
        return this.request('blockchain.address.history', [address, pagination])
    }
    ...
    blockchainAddress_getUtxo(address){
        return this.request('blockchain.address.get_utxo', [address])
    }
    blockchainAddress_getUtxoAmount(address, amount){
        return this.request('blockchain.address.get_utxo_amount', [address, amount])
    }
    ...
    blockchainTransaction_getVerbose(tx_hash){
        return this.request('blockchain.transaction.get_verbose', [tx_hash])
    }
